...
@pytest.mark.django_db
def test_proxy_lesson_create_view_success(authenticated_api_client):
    with requests_mock.mock() as mocked_request:
...
@pytest.mark.django_db
def test_proxy_lesson_update_view_success(authenticated_api_client):
    lesson_uuid = "00981f5a-6685-4589-ad77-6a7e2a70ed9d"
    with requests_mock.mock() as mocked_request:
        with open("auth/proxy/tests/pdf_test.pdf", "rb") as pdf_file:
            data = {
...
@pytest.mark.django_db
def test_proxy_lesson_partial_update_view_success(authenticated_api_client):
    lesson_uuid = "00981f5a-6685-4589-ad77-6a7e2a70ed9d"
    with requests_mock.mock() as mocked_request:
...
@pytest.mark.django_db
def test_proxy_lesson_delete_view_success(authenticated_api_client):
    lesson_uuid = "00981f5a-6685-4589-ad77-6a7e2a70ed9d"
    with requests_mock.mock() as mocked_request:
