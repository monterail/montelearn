...
email_auth_urls = [
    ...
    path("auth/email/password/change/", EmailPasswordChange.as_view(), name="rest_password_change"),
    path("auth/email/password/reset/", EmailPasswordReset.as_view(), name="rest_password_reset"),
    path(
    ...
    path("auth/email/register/verify-email/", VerifyEmail.as_view(), name="rest_verify_email"),
